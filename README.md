...
Everyday use happens in a compatible MCP client through chat, without a
console. Read the [step-by-step onboarding](ONBOARDING.md) to connect, perform
the one-time local login, and troubleshoot common issues.

Try: “Find SST jobs in Cali”, “review my profile”, or “show me this offer's
questions”. The assistant always fetches current questions and asks for
